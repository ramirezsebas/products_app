...
void main() {
  group('user model ...', () {
    test('fromJson should return correct model', () {
      ...
      // Assert
      expect(user.name, 'Terry Medhurst');
      expect(user.avatarUrl, 'https://robohash.org/Terry.png?set=set4');
    });
    ...
    test('fromJson handle default cases', () {
      ...
      // Act
      final product = UserModel.fromJson(json);

      // Assert
      expect(product.name, '');
      expect(product.avatarUrl, '');
    });
  });
}
